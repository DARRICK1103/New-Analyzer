...
entertainment_button = Button(frame1, text="Entertainment", font=font, bg="white", fg="black", padx=15, pady=5, width=13)
...
label_trending = Label(frame2, text="Entertainment", font=('Arial', 25),)
label_trending.pack()
# Arrange the elements
frame1.grid(row=0, column=0)
frame2.grid(row=1, column=0, sticky="W", padx=30, pady=10)

news = newsAPI.getEntertainment()

frame3 = Frame(content_frame)

structure1 = nw2.news2(frame3, news)
structure1.create("Entertainment", user_id)
...
structure2.create("Entertainment", user_id)
...
structure3.create("Entertainment", user_id)
...
structure4.create("Entertainment", user_id)
...
structure5.create("Entertainment", user_id)
