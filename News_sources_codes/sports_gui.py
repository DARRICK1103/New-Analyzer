...
sports_button = Button(frame1, text="Sports", font=font, bg="white", fg="black", padx=15, pady=5, width=13)
...
label_trending = Label(frame2, text="Sports", font=('Arial', 25),)
label_trending.pack()
...
structure2.create("Sports", user_id)
...
structure3.create("Sports", user_id)
...
structure4.create("Sports", user_id)
...
structure5.create("Sports", user_id)
