...
news = newsAPI.getNewsItem() # get news
structure1 = nw2.news2(frame3, news)
structure1.create("General", user_id)
...
structure2.create("General", user_id)
...
structure3.create("General", user_id)
...
structure4.create("General", user_id)
...
structure5.create("General", user_id)
